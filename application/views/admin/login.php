...
<div id="login">
	...
	<div id="login_content">
		<div class="loginForm">
            ...
            if(isset($message)){
                ?>
                <p><span class="Errormsg"><?php echo $message['message']; ?></span></p>
                <?php
            }
            ?>
			<form method="post" action="index.php/admin/webmaster/login" >
				<p>
					<label>帐号：</label>
				...
				<p>
					<img id="verifyImg" src="kaptcha.jpg" style="margin-top:10px;" onClick="fleshVerify()" border="0" title="点击刷新验证码" alt="点击刷新验证码" style="cursor:pointer" align="absmiddle"/>
				</p>
				<div class="login_bar" >
